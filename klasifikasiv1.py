    ...
    def modeljst(self):
        try:
            ...
            def baseline_model():
                ...
                # Compile model
                model.compile(loss = 'categorical_crossentropy', optimizer = train, metrics = ['accuracy'])
                return model
            ...
            y_pred = cross_val_predict(estimator, input, output, cv = kfold, verbose = 1, fit_params = {'callbacks': [es, mc]})
