    ...
    def modeljst(self):
        try:
            ...
            if(kelas == 0):
                ...
                # data_csv = 'dataBBU.csv'
            elif(kelas == 1):
                input = self.inputB
                inputdim = 5
                best_model = 'best_model_TBU.h5'
                # data_csv = 'dataTBU.csv'
            else:
                input = self.inputB
                inputdim = 5
                best_model = 'best_model_BBTB.h5'
                # data_csv = 'dataBBTB.csv'
            ...
            y_true = np.argmax(output, axis = 1)

            #memanggil parameter pelatihan JST dari user
            hLayer = 1
            # a1 = ["relu","tanh"]
            # a2 = ["relu","tanh"]
            # n2 = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50] 
            ...
            for training in tr:
                for aktivasi1 in a1:
                    for aktivasi2 in a2:
                        ...
                        # if( aktivasi1 == 'relu'):
                        #     if(aktivasi2 == 'relu'):
                        #         data_csv = 'dataBBUv1.csv'
                        #     else:
                        #         data_csv = 'dataBBUv2.csv'
                        # else:
                        #     if(aktivasi2 == 'relu'):
                        #         data_csv = 'dataBBUv3.csv'
                        #     else:
                        #         data_csv = 'dataBBUv4.csv'
                        ...
                        for neuron2 in n2:   
                            for neuron1 in n1:
                                ...
                                def baseline_model():
                                    # create model
                                    model = Sequential()
                                    model.add(Dense(neuron1, input_dim = inputdim, activation = aktivasi1))
                                    if(hLayer == 1):
                                ...
                                for train, val in kfold.split(input):
                                    ...
                                    print(conf_mat)
                                    accu.append(accuracy(conf_mat) * 100)
                                    avg_loss.append(test_loss)

                                acc.append(sum(accu)/kfold.n_splits)
                                avg_los.append(sum(avg_loss)/kfold.n_splits)
                        # data = np.asarray([acc, avg_los])
                        print(accu)
                        print(avg_loss)
                        print(acc)
                        print(avg_los)
