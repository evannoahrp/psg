...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelJudul2.setGeometry(QtCore.QRect(210, 40, 520, 20))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line.setGeometry(QtCore.QRect(0, 69, 941, 31))
        ...
        self.tableRD = QtWidgets.QTableWidget(self.groupBoxRD)
        self.tableRD.setGeometry(QtCore.QRect(20, 20, 510, 120))
        self.tableRD.setRowCount(5)
        self.tableRD.setColumnCount(5)
        self.tableRD.setObjectName("tableRD")
        item = QtWidgets.QTableWidgetItem()
        self.tableRD.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableRD.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableRD.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableRD.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableRD.setHorizontalHeaderItem(4, item)
        ...
        self.tablePreprocessing = QtWidgets.QTableWidget(self.groupBoxPreprocessing)
        self.tablePreprocessing.setGeometry(QtCore.QRect(20, 20, 510, 120))
        self.tablePreprocessing.setRowCount(5)
        self.tablePreprocessing.setColumnCount(5)
        self.tablePreprocessing.setObjectName("tablePreprocessing")
        item = QtWidgets.QTableWidgetItem()
        self.tablePreprocessing.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tablePreprocessing.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tablePreprocessing.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tablePreprocessing.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tablePreprocessing.setHorizontalHeaderItem(4, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tableRD.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Jenis Kelamin"))
        item = self.tableRD.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Berat Badan"))
        item = self.tableRD.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "PB/TB"))
        item = self.tableRD.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Posisi Diukur"))
        item = self.tableRD.horizontalHeaderItem(4)
        ...
        item = self.tablePreprocessing.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Jenis Kelamin"))
        item = self.tablePreprocessing.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Berat Badan"))
        item = self.tablePreprocessing.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "PB/TB"))
        item = self.tablePreprocessing.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Posisi Diukur"))
        item = self.tablePreprocessing.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Umur"))
